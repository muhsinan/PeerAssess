                          ...
                          {formData.isHidden && (
                            <div className="mt-3 ml-6 p-3 bg-orange-50 rounded-md">
                              <p className="text-xs text-orange-800">
                                <strong>Hidden Assignment:</strong> This assignment will only be visible to instructors. Students will not see it in their assignment list or dashboard until you make it visible.
                              </p>
                            </div>
                          )}
                        </div>
